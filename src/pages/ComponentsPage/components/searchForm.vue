...
<div class="ces-search">
    <el-form :size="size" inline :label-width="labelWidth">
        <el-form-item v-for='item in searchComponents' :label="item.label" :key="item.label">
            <!-- 输入框 -->
            <el-input
            ...
            <el-checkbox-group
                ...
                :size="size || item.size"
                :disabled="item.disable && item.disable(searchData[item.prop])">
                <el-checkbox v-for="ch in item.checkboxList" :label="ch.label" :key="ch.value">{{ch.label}}</el-checkbox>
            </el-checkbox-group>
            <!-- 日期 -->
            <el-date-picker
                v-if="item.type==='date'"
